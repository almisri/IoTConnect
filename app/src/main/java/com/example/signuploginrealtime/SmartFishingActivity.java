    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Kirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PesananClass layananClass = new PesananClass(ProjekName, ProjekTelepon, deskripsi, "Pengajuan_pesanan", "-","-","Smart Fishing");
                ...
                Intent intent = new Intent(SmartFishingActivity.this, DashboardToMonitoringActivity.class);
